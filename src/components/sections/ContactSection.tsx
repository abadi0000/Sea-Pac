      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            {/* WhatsApp */}
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-sebaaq-blue/50 transition-all duration-300 group">
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-sebaaq-blue/50 transition-all duration-300 group">
              ...
              <p className="text-sebaaq-blue font-mono">+966 920 031 826</p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-sebaaq-blue/50 transition-all duration-300 group">
              ...
              <p className="text-sebaaq-blue">info@sebaaq.com</p>
            </div>
          </div>
