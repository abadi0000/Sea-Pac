...
const CarWashParts = () => {
  const parts = [
    {
      name: "فرش الغسيل (Foam/Nylon Brushes)",
      description: "لضمان تنظيف شامل ولطيف لسطح السيارة",
      icon: Brush,
      image: "https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=400&q=80"
    },
    {
      name: "مضخات الضغط العالي",
      description: "لتوفير تدفق قوي للمياه ومحاليل التنظيف",
      icon: Gauge,
      image: "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=400&q=80"
    },
    {
      name: "فوهات الرش (Nozzles)",
      description: "لتوزيع الماء والمواد الكيميائية بدقة وكفاءة",
      icon: Droplets,
      image: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=400&q=80"
    },
    {
      name: "خراطيم المياه والضغط",
      description: "لنقل المياه ومحاليل التنظيف عبر النظام",
      icon: Zap,
      image: "https://images.unsplash.com/photo-1531297484001-80022131f5a1?auto=format&fit=crop&w=400&q=80"
    },
    {
      name: "وحدات التجفيف (Air Blowers/Dryers)",
      description: "لضمان جفاف سريع وكامل للسيارات بعد الغسيل",
      icon: Wind,
    ...
    {
      name: "موزعات الكيماويات (Detergent Dispensers)",
      description: "لخلط وتوزيع الشامبو والواكس وغيرها من المواد",
      icon: Beaker,
      image: "https://images.unsplash.com/photo-1482938289607-e9573fc25ebb?auto=format&fit=crop&w=400&q=80"
    },
    {
      name: "عجلات التوجيه والمسارات",
      description: "لتوجيه آلة الغسيل بدقة على طول مسارها",
      icon: Cog,
      image: "https://images.unsplash.com/photo-1469474968028-56623f02e42e?auto=format&fit=crop&w=400&q=80"
    },
    {
      name: "أذرع الغسيل الدوارة",
      description: "لتغطية شاملة وتنظيف فعال بدون لمس أو بلمس خفيف",
      icon: RotateCcw,
      image: "https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?auto=format&fit=crop&w=400&q=80"
    },
    {
      name: "صمامات التحكم في المياه",
      description: "لتنظيم تدفق المياه وإيقافها في الأوقات المحددة",
      icon: Settings,
      ...
      <section className="relative py-20 bg-gradient-to-br from-sebaaq-midnight to-sebaaq-charcoal overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          <h1 className="font-playfair text-4xl md:text-6xl font-bold text-white mb-6">
            قطع غيار مغاسل السيارات الأوتوماتيكية
            <span className="gradient-text block mt-2">دعم شامل لأنظمة الغسيل</span>
          </h1>
          <p className="text-lg md:text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
            احصل على قطع الغيار المتخصصة عالية الجودة التي تضمن استمرارية عمل مغاسل السيارات بأفضل أداء
          </p>
        </div>
      </section>
            ...
            {parts.map((part, index) => (
              <Card key={index} className="overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:scale-105 hover:bg-gradient-to-br hover:from-sebaaq-blue/5 hover:to-blue-400/5">
                ...
                <CardHeader>
                  ...
                  <Link to="/parts-maintenance" state={{ machineType: 'carwash', partName: part.name }}>
