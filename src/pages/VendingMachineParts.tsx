...
const VendingMachineParts = () => {
  const parts = [
    {
      name: "آلية توزيع المنتجات (Spring/Conveyor)",
      description: "لضمان تسليم سلس ودقيق للمنتجات",
      icon: Package,
      image: "https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=400&q=80"
    },
    {
      name: "قارئ العملات الورقية والمعدنية",
      description: "لقبول المدفوعات النقدية بكفاءة عالية",
      icon: Coins,
      image: "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=400&q=80"
    },
    {
      name: "وحدة التحكم الرئيسية (PCB Board)",
      description: "العقل المدبر الذي يتحكم في جميع وظائف الماكينة",
      icon: Cpu,
      image: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=400&q=80"
    },
    {
      name: "شاشة اللمس/العرض",
      description: "لتوفير واجهة تفاعلية وواضحة للمستخدم",
      icon: Monitor,
      image: "https://images.unsplash.com/photo-1531297484001-80022131f5a1?auto=format&fit=crop&w=400&q=80"
    },
    {
      name: "وحدة التبريد/التسخين",
      description: "للحفاظ على درجة الحرارة المثالية للمنتجات",
      icon: Thermometer,
    ...
    {
      name: "محرك الدرج/الرفوف",
      description: "لتحريك الرفوف أو الأدراج لتسليم المنتجات",
      icon: Cog,
      image: "https://images.unsplash.com/photo-1482938289607-e9573fc25ebb?auto=format&fit=crop&w=400&q=80"
    },
    {
      name: "مفتاح الباب/القفل الإلكتروني",
      description: "لضمان أمان الماكينة ومحتوياتها",
      icon: Lock,
      image: "https://images.unsplash.com/photo-1469474968028-56623f02e42e?auto=format&fit=crop&w=400&q=80"
    },
    {
      name: "وحدة الإضاءة الداخلية (LED Strips)",
      description: "لإبراز المنتجات وجذب الانتباه",
      icon: Lightbulb,
      image: "https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?auto=format&fit=crop&w=400&q=80"
    },
    {
      name: "لوحة المفاتيح الرقمية (إذا وجدت)",
      description: "لإدخال الرموز أو الاختيارات يدوياً",
      icon: Keyboard,
      ...
      <section className="relative py-20 bg-gradient-to-br from-sebaaq-midnight to-sebaaq-charcoal overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          <h1 className="font-playfair text-4xl md:text-6xl font-bold text-white mb-6">
            قطع غيار مكائن البيع الذاتي
            <span className="gradient-text block mt-2">دعم شامل لاستمرارية العمل</span>
          </h1>
          <p className="text-lg md:text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
            احصل على قطع الغيار الأصلية عالية الجودة التي تضمن استمرارية عمل مكائن البيع الذاتي بأفضل أداء
          </p>
        </div>
      </section>
            ...
            {parts.map((part, index) => (
              <Card key={index} className="overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:scale-105 hover:bg-gradient-to-br hover:from-sebaaq-blue/5 hover:to-blue-400/5">
                ...
                <CardHeader>
                  ...
                  <Link to="/parts-maintenance" state={{ machineType: 'vending', partName: part.name }}>
...
export default VendingMachineParts;
