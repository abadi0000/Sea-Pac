...
const ProductionLineParts = () => {
  const parts = [
    {
      name: "المحركات الكهربائية (Motors)",
      description: "لتوفير القوة الدافعة للآلات ضمن خط الإنتاج",
      icon: Zap,
      image: "https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=400&q=80"
    },
    {
      name: "الأحزمة الناقلة (Conveyor Belts)",
      description: "لنقل المنتجات والمواد الخام بسلاسة عبر الخط",
      icon: Package,
      image: "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=400&q=80"
    },
    {
      name: "المضخات الصناعية",
      description: "لضخ السوائل والمواد اللزجة بكفاءة عالية",
      icon: Droplets,
      image: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=400&q=80"
    },
    {
      name: "الصمامات (Valves)",
      description: "للتحكم في تدفق المواد والضغط داخل الأنابيب",
      icon: Settings,
      image: "https://images.unsplash.com/photo-1531297484001-80022131f5a1?auto=format&fit=crop&w=400&q=80"
    },
    {
      name: "وحدات التحكم المنطقية القابلة للبرمجة (PLCs)",
      description: "لبرمجة وأتمتة عمليات خط الإنتاج",
      icon: Cpu,
    ...
    {
      name: "الشفرات والقواطع (لآلات التعبئة/التقطيع)",
      description: "لعمليات التقطيع الدقيقة والتعبئة المحكمة",
      icon: Scissors,
      image: "https://images.unsplash.com/photo-1482938289607-e9573fc25ebb?auto=format&fit=crop&w=400&q=80"
    },
    {
      name: "علب التروس (Gearboxes)",
      description: "لتعديل السرعة وعزم الدوران للمحركات",
      icon: Cog,
      image: "https://images.unsplash.com/photo-1469474968028-56623f02e42e?auto=format&fit=crop&w=400&q=80"
    },
    {
      name: "المحامل (Bearings)",
      description: "لتقليل الاحتكاك وضمان الحركة السلسة للأجزاء الدوارة",
      icon: CircleDot,
      image: "https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?auto=format&fit=crop&w=400&q=80"
    },
    {
      name: "لوحات التحكم الكهربائية (Control Panels)",
      description: "لتوفير واجهة مركزية للتحكم ومراقبة العمليات",
      icon: Monitor,
      ...
      <section className="relative py-20 bg-gradient-to-br from-sebaaq-midnight to-sebaaq-charcoal overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          <h1 className="font-playfair text-4xl md:text-6xl font-bold text-white mb-6">
            قطع غيار أنظمة خطوط الإنتاج والمصانع
            <span className="gradient-text block mt-2">دعم شامل للعمليات الصناعية</span>
          </h1>
          <p className="text-lg md:text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
            احصل على قطع الغيار الصناعية عالية الجودة التي تضمن استمرارية العمليات الإنتاجية بأعلى كفاءة
          </p>
        </div>
      </section>
            ...
            {parts.map((part, index) => (
              <Card key={index} className="overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:scale-105 hover:bg-gradient-to-br hover:from-sebaaq-blue/5 hover:to-blue-400/5">
                ...
                <CardHeader>
                  ...
                  <Link to="/parts-maintenance" state={{ machineType: 'production', partName: part.name }}>
...
export default ProductionLineParts;
