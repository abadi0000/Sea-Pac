        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-4xl mx-auto leading-relaxed">
              "سـي بـاك" هي ثمرة خبرتي الطويلة وعلاقاتي الممتدة في السوقين الصيني والسعودي. كشركة سعودية ناشئة، نلتزم بتقديم خدمات لوجستية شاملة، من مصانع الصين مباشرة إلى العميل في المملكة.
            </p>
          </div>
